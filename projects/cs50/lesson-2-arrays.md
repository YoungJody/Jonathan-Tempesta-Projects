...
Part of [CS50x](../cs50.md) · **Language:** C · **Topics:** arrays, strings, command-line arguments

## Scrabble
Two-player word game: each player enters a word, the program scores it with Scrabble letter values, and it declares the winner or a tie.
**Practiced:** arrays as lookup tables, iterating over strings, character arithmetic.
