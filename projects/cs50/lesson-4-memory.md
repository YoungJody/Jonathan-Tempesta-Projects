...
Applies four filters to BMP images: grayscale, reflect, blur, and edge detection with the Sobel operator. Edge detection is what separates this from the easier version of the problem, which stops at grayscale, sepia, reflect, and blur.
